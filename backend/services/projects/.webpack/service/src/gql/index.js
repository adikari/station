...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/gql/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"makeContext\", function() { return makeContext; });\n/* harmony import */ var _usecases_project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../usecases/project */ \"./src/usecases/project/index.js\");\n\n\nconst makeContext = ({\n  event\n}) => {\n  if (!event) {\n    return Promise.reject(new Error('No lambda event detected'));\n  }\n\n  return {\n    project: _usecases_project__WEBPACK_IMPORTED_MODULE_0__,\n    viewer: {\n      id: 'ck2ppvh7e4q9s0714yi58vdqf'\n    }\n  };\n};\n\n\n\n//# sourceURL=webpack:///./src/gql/make-context.js?");

/***/ }),

/***/ "./src/gql/make-schema.js":
/*!********************************!*\
  !*** ./src/gql/make-schema.js ***!
  \********************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"typeDefs\", function() { return typeDefs; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"resolvers\", function() { return resolvers; });\n/* harmony import */ var lodash_property__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash.property */ \"lodash.property\");\n/* harmony import */ var lodash_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_property__WEBPACK_IMPORTED_MODULE_0__);\n\nconst typeDefs = `\n  extend type Query {\n    projects: ProjectList\n  }\n\n  extend type Mutation {\n    createProject(input: ProjectInput!): Project\n  }\n\n  type Pagination {\n    pageSize: Int\n    total: Int\n    page: Int\n  }\n\n  type ProjectList {\n    projects: [Project]\n    pagination: Pagination\n  }\n\n  input ProjectInput {\n    name: String!\n    description: String\n    shortDescription: String\n    thumbnail: String\n    cover: String\n    owner: ID\n    positions: [PositionInput]\n    tags: [TagInput]\n  }\n\n  type User {\n    id: ID\n    username: String\n    email: String\n    firstname: String\n    lastname: String\n    accessRole: AccessRole\n    followingProjects: [Project]\n    owningProjects: [Project]\n  }\n\n  type Project {\n    id: ID\n    createdAt: String\n    updatedAt: String\n    shortDescription: String\n    name: String\n    thumbnail: String\n    cover: String\n    description: String\n    positions: [Position]\n    followers: [User]\n    owner: User\n    tags: [Tag]\n  }\n\n  type Position {\n    id: ID\n    name: String\n    description: String\n    user: User\n    projects: [Project]\n  }\n\n  input PositionInput {\n    id: ID\n    name: String\n    description: String\n  }\n\n  type Tag {\n    id: ID\n    name: String\n  }\n\n  input TagInput {\n    id: ID\n    name: String\n  }\n\n  enum AccessRole {\n    ADMIN\n    USER\n  }\n`;\nconst resolvers = {\n  Query: {\n    projects: (_, {\n      page = 1,\n      pageSize = 10\n    }, {\n      project\n    }) => project.getProjects({\n      page,\n      pageSize\n    })\n  },\n  Mutation: {\n    createProject: (_, {\n      input\n    }, {\n      project,\n      viewer: {\n        id\n      }\n    }) => project.createProject({ ...input,\n      owner: id\n    })\n  },\n  ProjectList: {\n    projects: projects => projects,\n    pagination: (_, {\n      page = 1,\n      pageSize = 10\n    }, {\n      project\n    }) => project.getProjectCount().then(total => ({\n      total,\n      page,\n      pageSize\n    }))\n  },\n  Pagination: {\n    total: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('total'),\n    page: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('page'),\n    pageSize: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('pageSize')\n  },\n  Project: {\n    id: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('id'),\n    name: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('name'),\n    description: lodash_property__WEBPACK_IMPORTED_MODULE_0___default()('description')\n  }\n};\n\n\n//# sourceURL=webpack:///./src/gql/schemas/project/index.js?");

/***/ }),

/***/ "./src/gql/schemas/root.js":
/*!*********************************!*\
  !*** ./src/gql/schemas/root.js ***!
  \*********************************/
/*! exports provided: typeDefs, resolvers */
...
/*!************************************************!*\
  !*** ./src/usecases/project/create-project.js ***!
  \************************************************/
/*! exports provided: makeCreateProject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"makeCreateProject\", function() { return makeCreateProject; });\nconst makeCreateProject = ({\n  db\n}) => ({\n  name,\n  description,\n  owner\n}) => db.createProject({\n  name,\n  description,\n  owner: {\n    connect: {\n      id: owner\n    }\n  }\n});\n\n//# sourceURL=webpack:///./src/usecases/project/create-project.js?");
...
/*!***************************************************!*\
  !*** ./src/usecases/project/get-project-count.js ***!
  \***************************************************/
/*! exports provided: makeGetProjectCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"makeGetProjectCount\", function() { return makeGetProjectCount; });\nconst makeGetProjectCount = ({\n  db\n}) => () => db.projectsConnection().aggregate().count();\n\n//# sourceURL=webpack:///./src/usecases/project/get-project-count.js?");
...
/*!**********************************************!*\
  !*** ./src/usecases/project/get-projects.js ***!
  \**********************************************/
/*! exports provided: makeGetProjects */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"makeGetProjects\", function() { return makeGetProjects; });\nconst makeGetProjects = ({\n  db\n}) => ({\n  page,\n  pageSize\n}) => db.projects({\n  first: pageSize,\n  skip: pageSize * (page - 1)\n});\n\n//# sourceURL=webpack:///./src/usecases/project/get-projects.js?");
...
/*!***************************************!*\
  !*** ./src/usecases/project/index.js ***!
  \***************************************/
/*! exports provided: getProjects, getProjectCount, createProject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getProjects\", function() { return getProjects; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getProjectCount\", function() { return getProjectCount; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"createProject\", function() { return createProject; });\n/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../db */ \"./src/db/index.js\");\n/* harmony import */ var _get_projects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./get-projects */ \"./src/usecases/project/get-projects.js\");\n/* harmony import */ var _create_project__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create-project */ \"./src/usecases/project/create-project.js\");\n/* harmony import */ var _get_project_count__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./get-project-count */ \"./src/usecases/project/get-project-count.js\");\n\n\n\n\nconst getProjects = Object(_get_projects__WEBPACK_IMPORTED_MODULE_1__[\"makeGetProjects\"])({\n  db: _db__WEBPACK_IMPORTED_MODULE_0__[\"db\"]\n});\nconst getProjectCount = Object(_get_project_count__WEBPACK_IMPORTED_MODULE_3__[\"makeGetProjectCount\"])({\n  db: _db__WEBPACK_IMPORTED_MODULE_0__[\"db\"]\n});\nconst createProject = Object(_create_project__WEBPACK_IMPORTED_MODULE_2__[\"makeCreateProject\"])({\n  db: _db__WEBPACK_IMPORTED_MODULE_0__[\"db\"]\n});\n\n//# sourceURL=webpack:///./src/usecases/project/index.js?");
