...
/* harmony import */ var _src_clients_bugsnag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/clients/bugsnag */ "./src/clients/bugsnag/index.js");

var __jsx = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement;



var StationApp = function StationApp(_ref) {
  var pageProps = _ref.pageProps,
      Component = _ref.Component,
      router = _ref.router;
  return __jsx(_src_clients_bugsnag__WEBPACK_IMPORTED_MODULE_2__["ErrorBoundary"], null, __jsx(Component, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, router, pageProps)));
};

/* harmony default export */ __webpack_exports__["default"] = (StationApp);

/***/ }),

/***/ "./src/clients/bugsnag/index.js":
/*!**************************************!*\
  !*** ./src/clients/bugsnag/index.js ***!
  \**************************************/
/*! exports provided: bugsnagClient, ErrorBoundary */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _bugsnag_plugin_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @bugsnag/plugin-react */ "./node_modules/@bugsnag/plugin-react/dist/bugsnag-react.js");
...
/* harmony import */ var _config_get_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../config/get-config */ "./src/config/get-config.js");
/* harmony import */ var _config_get_config__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_config_get_config__WEBPACK_IMPORTED_MODULE_3__);





var _getConfig = Object(_config_get_config__WEBPACK_IMPORTED_MODULE_3__["getConfig"])(),
    BUGSNAG_API_KEY = _getConfig.BUGSNAG_API_KEY;

var bugsnagClient = _bugsnag_js__WEBPACK_IMPORTED_MODULE_1___default()({
  apiKey: BUGSNAG_API_KEY,
  releaseStage: "dev"
});
bugsnagClient.use(_bugsnag_plugin_react__WEBPACK_IMPORTED_MODULE_2___default.a, react__WEBPACK_IMPORTED_MODULE_0__);
...
var _getConfig = function getConfig(env) {
  ...
  try {
    ...
    return __webpack_require__("./src/config sync recursive ^\\.\\/.*\\.config\\.js$")("./".concat(environment, ".config.js"));
  } catch (err) {
...
module.exports = {
  getConfig: function getConfig() {
    return _objectSpread({}, _getConfig("dev"), {
      STAGE: "dev"
    });
  }
};
